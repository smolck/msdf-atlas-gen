 ...
 *  An atlas generator maintains the atlas bitmap (AtlasStorage) and its layout
 * and facilitates generation of bitmap representation of glyphs. The layout of
 * the atlas is given by the caller.
 */
...
public:
  ...
  /// Resizes the atlas and rearranges the generated pixels according to the
  /// remapping array
