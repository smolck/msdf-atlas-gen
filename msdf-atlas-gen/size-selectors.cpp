...
SquareSizeSelector<MULTIPLE>::SquareSizeSelector(int minArea)
...
template <int MULTIPLE> void SquareSizeSelector<MULTIPLE>::updateCurrent() {
  if (upperBound < 0)
...
SquarePowerOfTwoSizeSelector::SquarePowerOfTwoSizeSelector(int minArea)
    : side(1) {
