...
/**
 * An implementation of AtlasGenerator that uses the specified generator
 * function and AtlasStorage class and generates glyph bitmaps immediately (does
 * not return until all submitted work is finished), but may use multiple
